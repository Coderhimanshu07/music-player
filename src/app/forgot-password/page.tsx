...
import { Music, Mail, Loader2, ArrowRight, ArrowLeft } from "lucide-react";
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-bg-base px-4">
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-text-subdued">Enter your email to receive a reset link</p>
        </div>
        ...
        <div className="bg-bg-elevated/40 backdrop-blur-xl border border-white/5 rounded-3xl p-8 shadow-2xl">
          ...
          {message ? (
            <div className="text-center space-y-6">
              <div className="p-4 bg-brand/10 border border-brand/20 rounded-xl text-brand text-sm">
                {message}
              </div>
              <Link href="/login" className="inline-flex items-center gap-2 text-text-subdued hover:text-white transition-colors">
                <ArrowLeft size={16} />
                Back to Login
              </Link>
            </div>
            ...
            <form onSubmit={handleResetRequest} className="space-y-6">
              ...
              <div className="text-center">
                <Link href="/login" className="inline-flex items-center gap-2 text-text-subdued hover:text-white text-sm transition-colors">
                  <ArrowLeft size={14} />
                  Back to Login
                </Link>
              </div>
