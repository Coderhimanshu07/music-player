...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If sign-in fails, check the profiles table to see if the user exists
      ...
      if (profile) {
        // User exists in profiles table, so the password must be wrong
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-bg-base px-4">
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-text-subdued">Sign in to continue to Melody</p>
        </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                <label className="text-sm font-medium text-text-subdued">Password</label>
